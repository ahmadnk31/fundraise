...
export class EmailService {
    static FROM_EMAIL = process.env.SES_FROM_EMAIL;
    static FROM_NAME = process.env.SES_FROM_NAME || 'FundRaise Platform';
    ...
    static async sendWelcomeEmail(email, firstName, verificationToken) {
    ...
    static async sendDonationReceiptEmail(email, donorName, amount, campaignTitle, donationId) {
        await this.sendEmail({
            to: email,
    ...
    static async sendCampaignApprovalEmail(email, firstName, campaignTitle, campaignUrl) {
        await this.sendEmail({
            to: email,
